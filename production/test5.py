...
def iniFunctionTest5():
    ...
    try:
        element = driver.find_element(By.CSS_SELECTOR, "#mps-index > section > section > main > div > div.app-mps-layout__content-body > div > div.app-mps-row.app-mps-grid > div.app-mps-col.app-mps-grid__item-8 > div > div:nth-child(2) > div > div.app-mps-card__content > div:nth-child(3) > div.app-mps-media__left > div > span")
